  ...
  return (
    ...
    <div className="flex border-section mx-auto grid  grid-cols-1 gap-x-8 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
      <div className="flex-1 lg:pr-8 lg:pt-4">
          ...
          <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none display-center">
            {features.map((feature) => (
              <div key={feature.name} className="relative pl-9">
                <dt className="flex font-semibold text-white space-x-20">
        ...
        <img className="pt-10 h-15 hidden sm:block " src={image}></img>
      </div>
...
// make the phone and email be smaller for mobile app 
// make the contact us page always in the same page 